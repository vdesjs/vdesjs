...
import { WXMLDocumentRegions, CSS_STYLE_RULE } from './embeddedSupport';

export function getCSSMode(cssLanguageService: CSSLanguageService, documentRegions: LanguageModelCache<WXMLDocumentRegions>, workspace: Workspace): LanguageMode {
	...
	return {
      ...
      console.log("cssMode doComplete")
			let embedded = embeddedCSSDocuments.get(document);
