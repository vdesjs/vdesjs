import { ITagData, IAttributeData, IValueData, IWXMLDataProvider, WXMLDataV1, MarkupContent } from '../wxmlLanguageTypes';
...
export class WXMLDataProvider implements IWXMLDataProvider {
	 ...
	 */
	constructor(private readonly id: string, customData: WXMLDataV1) {
